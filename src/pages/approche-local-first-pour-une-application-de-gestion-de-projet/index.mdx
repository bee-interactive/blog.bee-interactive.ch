...
<Challenge type="warning">
  ### Défi: Logique de synchronisation complexe

**Solution:** Commencer avec une stratégie simple "dernière écriture gagne",
puis ajouter progressivement la complexité des CRDTs.
...
**Solution:** Utiliser Laravel pour la synchronisation REST,
serveur WebSocket séparé pour le temps réel.
...
**Solution:** Utiliser le code splitting de Vite,
...
Cette architecture local-first représente l'avenir des applications professionnelles. Elle offre une expérience utilisateur supérieure en éliminant la dépendance au réseau tout en permettant la collaboration moderne.
