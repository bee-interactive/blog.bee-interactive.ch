...
import addTransactionsImg from './add-transactions.png'
import vatStatsImg from './vat-stats.png'
import categoryStatsImg from './category-stats.png'
...
Comment je gère (une partie) de ma vie : Mon passage de l’enfer d’Excel au paradis de Laravel
...
![Dashboard de l’application Taab](${dashboardImg} "Dashboard de l’application Taab")
...
![Menu de l’ajout des transactions](${addTransactionsImg} "Menu de l’ajout des transactions")
...
![Vue du résumé de la TVA de l’application Taab](${vatStatsImg} "Vue du résumé de la TVA de l’application Taab")
...
![Statistiques des catégories ajoutées dans Taab pour une vue d’ensemble sur 4 ans](${categoryStatsImg} "Statistiques des catégories ajoutées dans Taab pour une vue d’ensemble sur 4 ans")
