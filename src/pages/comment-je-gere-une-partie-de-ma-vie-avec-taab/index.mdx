...
![Dashboard de l’application Taab](./dashboard.png "Dashboard de l’application Taab")
...
![Menu de l’ajout des transactions](./add-transactions.png "Menu de l’ajout des transactions")
...
![Vue du résumé de la TVA de l’application Taab](./vat-stats.png "Vue du résumé de la TVA de l’application Taab")
...
![Statistiques des catégories ajoutées dans Taab pour une vue d’ensemble sur 4 ans](./category-stats.png "Statistiques des catégories ajoutées dans Taab pour une vue d’ensemble sur 4 ans")
